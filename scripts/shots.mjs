// Takes the README screenshots from the dev server, on a demo project, never on
// anyone's own work. Run the dev server with a HOME whose
// ~/.config/ope/library.json lists the demo project with numbered versions, and
// with "Add OPE to this project" already done in it. Then:
...
await page.click('#versionList [data-v="0"]'); await wait(800);   // unpick the version
await page.click('[data-dir="src"]'); await wait(200);
await page.click('[data-dir="ope-system"]'); await wait(200);
await page.click('[data-dir="ope-system/maps"]'); await wait(200);
